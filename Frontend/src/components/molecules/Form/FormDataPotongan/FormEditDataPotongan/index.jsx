...
const FormEditDataPotongan = () => {
    ...
    const updateDataPotongan = async (e) => {
        ...
        try {
            ...
            const response = await axios.patch(`http://localhost:8080/data_potongan/update/${id}`, formData, {
                headers: {
    ...
    useEffect(() => {
        const getDataById = async () => {
            try {
                const response = await axios.get(`http://localhost:8080/data_potongan/${id}`);
